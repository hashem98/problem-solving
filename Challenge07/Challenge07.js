...
const objLat = (obj) => {
    return `my name is ${obj.firstName[0].toUpperCase()}${obj.firstName.substring(1)} ${obj.lastName[0].toUpperCase()}${obj.lastName.substring(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`    // write your code here
